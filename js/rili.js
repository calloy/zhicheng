...
//	alert(m);
	...
	for (var i = 0;i < 42;i++) {
		...
		newhtml.setAttribute("class","rili-main-day-"+b[i][8]+" top-color-"+b[i][7]);
		if(b[i][6] == 1 ){
			newhtml.innerHTML="<div class='rili-tian rili-dangtian'>"+b[i][3]+"</div><span class='rili-nongli'>"+b[i][4]+"</span>";
		}else{
			newhtml.innerHTML="<div class='rili-tian '>"+b[i][3]+"</div><span class='rili-nongli''>"+b[i][4]+"</span>";
		}
